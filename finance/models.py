...
class HistoryPaymentStudent(models.Model):
    ...
    invoice = models.FileField(upload_to='student_invoices/', verbose_name='Квитанция', **NULLABLE)
...
class HistoryPaymentTeacher(models.Model):
    ...
    currency = models.CharField(verbose_name='Валюта', choices=CURRENCY_CHOICES, default=TENGE, max_length=5)
    invoice = models.FileField(upload_to='teacher_invoices/', verbose_name='Квитанция', **NULLABLE)
    comment = models.TextField(verbose_name='Комментарий к оплате', **NULLABLE)
...
class StudentSubscription(models.Model):
    ...
    is_active = models.BooleanField(verbose_name='Активная подписка', default=True, **NULLABLE)
